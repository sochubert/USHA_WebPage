...
const Content = () => {
    return (
        <div id="Section">
            <div className="first">
                <p className='first_text'><span className='first_text_small'>난</span> 뭐해서 먹고 살아야<span className='first_text_small'>하지?</span></p>
                <img src={process.env.PUBLIC_URL + `/assets/1_img.png`} className="first_img" />
                <div className="first_box">
                <Fade bottom>
                    <p className="first_description">자격증이나 따고 보자<span className='first_description_small'> 했더니,</span><br /><br /><span className="first_descrition_red">218만원 낭비...</span><br /><div className='first_description_sub'>잡코리아, 국내 4년제대학 3~4학년과 올해 졸업예정자 총 798명을 대상<br />'취업사교육 경험'관련 설문조사 진행  결과</div></p>
                </Fade>
            ...
            <div className="third">
                ...
                <Fade left>
                    <p className="third_description">STEP1. <span className="third_description_blue">취업 vs 창업</span> 정하셨나요?</p>
                </Fade>
                <hr />
            </div>
